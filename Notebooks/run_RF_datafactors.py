...
africa = pd.read_csv('../Data/africa-ML-DataFactors-updated.csv')
...
for i in np.arange(100):
    rf = RandomForestClassifier(n_estimators = 100, max_depth=5, criterion='log_loss')#, bootstrap=False, max_features=None)
...
pickle.dump(final_features, open('FinalFeaturesDataFactors/final_features_%s.pkl'%run_id,'wb'))
